...
as_of: '2026-07-30'
amended_on: null
reproduction_basis: 17 U.S.C. § 105 — work of the U.S. government
superseded_by: null
source_url: https://www.irs.gov/pub/irs-pdf/p1075.pdf
source_format: pdf
retrieved: '2026-07-30'
source_sha256: 8bdd88d3583dda6ce871dcf1cb11bbe3aa909af370d42d0b49b0e6a065760449
status: current
...
- Extent: 216 pages
- Reproduction basis: 17 U.S.C. § 105 — work of the U.S. government
...
General__________________________________________________________________23
...
Safeguards Website________________________________________________________24
Safeguards Mailbox ________________________________________________________25
...
2.E.4.3 Annual SSR Update Submission Instructions _________________________________ 72
...
MA-5: Maintenance Personnel ___________________________________________________ 138
...
PS-4: Personnel Termination ____________________________________________________ 158
...
SI-4: System Monitoring ________________________________________________________ 181
...
SR-10: Inspection of Systems and Components ____________________________________ 187
...
5)	 Treasury Directive 85-01 defined requirements have been included in several Section 4.0 NIST
...
52) Section 2.F.4, Other Precautions, has been updated to reflect annual requirement to validate and
...
56) Section 3.3.8, Public-Facing Systems, has been added and includes guidance from NIST SP
...
59) Exhibit 6, Contractor 45-Day Notification Procedures, has updated the signature requirement to
...
Safeguards Website for technical guidance.
...
70)  Multi-factor authentication  is required to be at  Authenticator Assurance Level 2 as defined in NIST
...
79)  Control Enhancement to restrict the accessing, processing, storage,  and transmission of FTI to
...
AC-6 Least Privilege X X X Need-to-
Know
...
Identification or Authentication X
...
Reporting X X X 2.C.1
AU-7 Audit Reduction and Report
Generation X X X 2.C.1
...
CA-1 Assessment, Authorization and
Monitoring Policy and Procedures X X
...
Protection Policy and Procedures X X
...
Service (Authoritative Source)* X X
...
Processes X X
SR-6 Supplier Assessments and
Reviews X
SR-10 Inspection of Systems or
Components X
...
Those agencies or agents that  legally r
eceive FTI  directly from either the IRS or from secondary sources
...
IRS Safeguards
reports and related communications in possession of federal, state, and local agencies
...
Additional guidance may be found at, https://www.irs.gov/uac/IRS-Freedom-of-Information, and questions
...
1 Forms include supporting schedules, attachments or
...
•	 Status of whether a return was filed, under examination or subject to other investigati on or
...
agency, body, or commission. Agencies must ev aluate the need for FTI before the data is requested or
disseminated. Inadvertent access is access to FTI without authori t y and is non- willful. Willful access to
...
An unauthorized disclosure has occurred when FTI is knowi n gly or due to gross negligence provided to
...
by IRC § 6103 to have it. Inadvertent d i
...
Limiting access to individuals on a need- to-know basi s reduces opportunities to “browse” or improperly
view FTI. Res tricting access to designat ed p ersonnel minimizes improper access or disclosure. FTI
...
Section 2.E, Reporting Requirements—6103(p)(4)(E)).  The SSR must include processing and safeguard
...
or revenue projections, it must submit a 45-day notification (see Section 1.9.4, Disclosing FTI to
...
of the Fiscal Service or another agency (see Federal Tax Information). Safeguard reviews are conducted
to determine the adequacy of safeguards as opposed to evaluating an agency’s programs. Several
factors will be considered when determining the need for a review, the type of review, and the frequenc y
...
interviewed.
A Preliminary Security Evaluation (PSE) call will be held to determine the scope of the review (see NIST
...
on the flow of the FTI, which may include, but are not limited to, field offices, consolidated data center s,
...
Safeguards (see Section 2.E.5, Corrective Action Plan) until all review findings are accepted as closed.
...
requested, and
2.	 Letter from the Head of Agency certifying that all residual FTI has been destroyed. (See Section
...
document that includes FTI, or the inadvertent disclosure of FTI, is known as a data breach. Se e the Data
...
identification of a possible issue involving FTI. See NIST IR-6, Incident Reporting and IR-8, Incident
Response Plan.
...
accesses or disclosures. If no FTI is involved, then there is no need to report the spill to t
he Office of
Safeguards or TIGTA. If the agency c annot show FTI was not involved within that 24-hour period, then
...
Even if all  information i s not available,  immediate notification is the most  important factor, not the
...
The agency will cooperate with TIGTA  and Office of  Safeguards investigators, providing data and access
...
Incident response policies and procedures required in NIST Control IR-1, Incident Response Policy and
...
Agencies must fully report to the IRS in their SSRs all  disclosures of FTI to contractors  and sub-
contractors. Any additional disclosures to contractors  and sub-contractors  must be reported using the
...
another contractor). See Section 2.E, Reporting Requirements - 6103(p)(4)(E) and Section 2.E.6,
...
appropriate termination of privileges and credentials. See NIST Control PS-7, External Personnel
Security.
...
of FTI to another entity. These agreements are negotiated and approved by IRS Disclosure w ith
...
sent to the Office of Safeguards via SDT. If SDT is not available, the agreement s may be emailed to the
...
2 and complete a Need and Use Justification for
...
submitted to the IRS Office of Safeguards as part of the annual SSR (see Section 1.4, State Tax
...
If the agency requires the use of a contractor to conduct tax modeling, revenue est imation or other
statistical activities, 45 -day notification requirements apply (see Section 1.9.4, Disclosing FTI to
Contractors).
2 Refer to https://www.irs.gov/privacy-disclosure/irs-freedom-of-information for contact information.
...
name of the individual(s) making the inspection. Recordkeeping log samples are provided in Section
2.A.2, Logs of FTI, (Electronic and Non-Electronic Receipts).
...
Secured Perimeter The perimeter is enclosed by slab-to-slab walls constructed of durable
...
Security Room A security room is a room that has been constructed to resist forced entry.
...
of the room.
Badged Employee During business hours, if authorized personnel serve as the second barrier
...
Security Container A security container is a storage device (e.g., turtle case, safe/vault, locked
...
800-53 Revision 5. These are identified in Section 4.0, NIST 800-53 Security and Privacy Controls. Per
...
access (e.g., electronic access control, key access, door monitor) to prevent unauthorized entry. Th e
...
For additional guidance, see NIST Control PE-2, Physical Access Authorizations. Also, see NIST Control
...
annually for control and accountability. Section 2.A, Recordkeeping Requirement, contains additional
...
training) and the contract must include Exhibit 7 safeguarding language. These facilities are subject to
...
acceptable alternative, where all requirements in Section 3.3.7 Virtual Desktop Infrastructure are met.
...
policies and procedures to be current, they need to have been updated or revalidated within the last thr ee
(3) years.
...
waist.
•	 FTI Disposal/Destruction – See Sections 2.A.2 FTI Logs, (Electronic and Non-Electronic
...
Sections 2.D.2 Training Requirements, 2.D.2.1 Disclosure Awareness Training, NIST Controls
...
to FTI.
•	 Transcript Delivery System (TDS) Audit Log Review (if applicable) – See Section 4.1, Access
Control
...
 Access Control – See Section 2.B.3.3 Controlling Access to Areas Containing FTI and NIST
...
•	 Audit and Accountability - see NIST Control AU-1, Audit and Accountability Policies and
Procedures
...
•	 Privacy Program Plan3 – See NIST Control PM-18, Privacy Program Plan
...
bureaus can be found at: https://www.fbi.gov/about-us/cjis/identity-history-summary-
...
www.uscis.gov/e-verify. This verification process may only be completed on new
...
individual sanctioned and any required administrative actions. See NIST Control PS- 8, Personnel
Sanctions.
...
unauthorized access or disclosure of FTI occurred and the rights of the taxpayer under IRC § 7431 (see
...
•	 Systemic means, including labeling; for additional information, see NIST Control MP-3, Media
Marking
...
4 Refer to https://www.irs.gov/privacy-disclosure/irs-freedom-of-information for contact information.
...
and should follow Publication 1075 requirements including the Background Investigation Requirements in
Section 2.C.3.
...
example, human services agencies administering benefit eligibility programs may not allow contractor s or
sub-contractors, including consolidated data center contractors, access to any FTI.
The agency must include, as appropriate, the requirements specified in Exhibit 7, Safeguarding Contract
Language.
...
• 	 The Exhibit 7  language must be included in the SLA  between the recipient agency and support
...
described in Section 2.D.3, Internal Inspections. Multiple agencies sharing a state support
...
purposes-matrix
Forms 1099 and W -2 information are not authorized by statute to be disclosed to contractor s or sub-
...
agencies may not contract for services that involve the disclosure of FTI to contractor s or sub-contractors.
...
prevention of unauthorized disclosure 2.D.2.1
...
7213, and 7213A (see Exhibit 4, Sanctions for Unauthorized Disclosure, and Exhibit 5, Civil Damages for
Unauthorized Disclosure).
...
Role-based training on handling FTI helps prevent unauthorized collections or uses of FTI. See NIST
...
-
SafeguardReports@irs.gov mailbox so the Office of Safeguards can assist you.
...
inspection reports (see Internal Inspection Template on the Office of Safeguards website) to the IRS with
...
5 The use of the Safeguards Disclosure Awareness Video does not completely satisfy the training
...
applicable).
The review of the computer facility must include the evaluation of c ybersecurity and physical security
controls.
...
•	 Email to Safeguards mailbox at SafeguardReports@irs.gov. Email transmissions must be sent by
...
on.
•	 Attachment filenam
es must follow a standardized naming convention, either by a logical order
...
•	 Designate an agency Safeguards POC, see Section 1.5 Coordinating Safeguards Within an
Agency
...
that will i nclude all devices and inputs/outputs
...
show the prohibition of using non-agenc y
...
implementation f or public-facing systems
displaying FTI
IA-5 Authenticator
Management
...
implementation for public-f acing systems
displaying FTI
...
PE-8 Visitor Access Records • Sample visitor access log
PM-5 Inventory of Personally
...
PS-8 Personnel Sanctions • Personnel Sanctions Policy and Procedures
RA-5 Vulnerability Scanning • Vulnerability scanning Policy and Procedures
Table 3 – SSR Evidentiary Documentation
800-53
Control
Control Name Evidentiary Documents (Artifacts) for Review
...
Access Co ntrol Policy
• Contracts with service providers containing
Publication 1075 Exhibit 7 l anguage
...
include internet-f acing network security
components that will pr otect the FTI network
SC-8
Transmission
Confidentiality and
Integrity
...
SI-2 Flaw Remediation • Patch Management Policy and Procedure
SI-3 Malicious Code
Protection
...
of FTI.
Refer to the Office of Safeguards website for additional guidance and instructions for completing the
document.
...
SafeguardReports@irs.gov, with the subject "SSR Extension Request". The body of the email must
...
must be sent to the Office of Safeguards via SDT or sent via email to SafeguardReports@irs.gov, with the
...
the FTI.
In addition to the initial receipt of FTI (see Section 1.1), the following circumstances or technology
...
Sub-Contractor Submit Notification and receive approval
Using FTI in Tax Modeling for
Tax Administration Submit Notification and receive approval
Using FTI in Pre-Production
Environment Submit Notification and receive approval
...
Refer to Section 3.3.1, Cloud Computing and the Safeguards website for more information related to
...
guidance in NIST Control MP-6, Media Sanitization. Electronic media containing FTI must not be
...
exchange or other servicing, any FTI on it must be destroyed by sanitizing according to guidance in NIST
...
See also MP-6. Media Sanitization. Additional media sanitization requirements are available on the Office
...
•	 The contract must contain safeguard language in Exhibit 7a and 7b, Safeguarding Contract
...
Section 4.0, NIST 800-53 Security and Privacy Controls, contains a catalog of technical and nontechnical
...
data center addresses where FTI will be received, processed, stored, access ed, protected and/or
...
controls, based on IRS Publication 1075, for how FTI is received, processed, stored, access ed,
...
described in Section 3.2, Table 8, Assessment Methodologies.
...
requirements of NIST Control IA-2, Identification and Authentication (Organizational Users). FTI end
...
FTI is considered nonpublic information and may never be posted or shared on an unauthent icated
...
IAL2: There is evidence that  supports the real-w
orld existence of the claimed identity and the
...
AAL2: There is a hi
gh confidence that the claimant controls authenticator(s) bound to the
...
Where applicable, the Office of Safeguards has included NIST control enhancement s, IRS and Treasury
...
(CE-13): Disable Accounts for High-Risk Individual: Disable
accounts of users posing a significant risk
within one (1) day of discovery of the risk.
Supplemental Guidance:  Users posing a significant risk to organizations include i ndividuals for whom
...
(IRS-Defined):  Users having accounts with administrator access  privil eges may access  those accounts
...
Supplemental Guidance: If individuals wit h administrator rights require email  or Internet access  beyond
local boundaries,  one alternative would be to issue separate, non-privileged accounts (one per  affected
individual)  for that purpose. For the considerations of this section, administrator accounts/rights  are those
that  allow for the installation or configuration of software on any agency assets receiving, processing,
storing, accessing,  protecting and/or transmitting  FTI.
Supplemental Guidance: If  individuals with administrator rights require email  or Internet access  beyond
local boundaries,  one alternative would be to issue separate, non-privileged accounts (one per  affected
individual)  for that purpose. For the considerations of this section, administrator accounts/rights  are those
that  allow for the installation or configuration of software on any agency assets storing, processing,
transmitting, or  protecting FTI.
...
Supplemental Guidance:  The warning banner must  be applied at th
e application,  database,  operating
system, and network device levels for all systems that receive, process, store, or  transmit FTI.
For sample warning banners approved by the O
ffice of Safeguards, see Exhibit 8.
AC-11: Device Lock
...
public web servers or systems designed for public access. Any remote access where (i) FTI is access ed
or (ii) an FTI environment is administered over the remote connection must be performed using
multifactor authentication. Requirements of multifactor authentication are provided in NIST Control IA-2:
...
Additional requirements for protecting FTI on wireless networks are provided in Section 3.3.6, Network
...
Additional requirements on protecting FTI accessed by mobile devices are provided in Section 3.3.4,
...
Additional VDI requirements are provided in Section 3.3.7, Virtual Desktop Infrastructure and on the
...
Allocate audit log storage capacity to accommodate the retention of audit records for the retention perio d.
...
Control Enhancements:
(CE-1) Storage Warning Capacity: Provide a warning to the SA and ISSO within 24 hours when allocated
...
resources involved, IP addresses involved, or information objects access ed.
AU-8: Time Stamps
...
conducting impartial assessments of systems. Impartiality implies that assessors are free f rom any
...
comes in the form of a memorandum signed by an agency official with fiduciary control over the secur ity
...
system level, or at the operating system or component level including, for example, on workstati ons,
...
Information Security Officers, system security officers  or  system security managers. Representation by
...
(IRS-Defined):  The agency shall ensure that
all  devices across the enterprise that store agency data are
appropriately reviewed for  security purposes  prior to connection or reconnection to the agency’s network,
(e.g. checks for  malicious code,  updates to malware detection software, critical software updates  and
patches,  operating system integrity and disabled hardware).
...
1.	  Enforce authorized access  to the corres
ponding private key; and
2.	 Map the authenticat
ed identity to the account of the individual or group; and
...
ensure that these identity management standards are viable, robust, reliable, sustainable,  and
interoperable as documented, the United States Government assesses and scopes the standards and
technology  implementations against applicable laws,  Executive Orders, directives, policies, regulations,
standards,  and  guidelines.  The result is NIST-issued implementation profiles of  approved protocols.
(IRS-Defined): Deploy identification and a
uthentication technology consistent with the results of the e-
authentication risk analysis.
See Section 3.3.8, Public-Facing Systems, for additional information regarding public-facing identification
and authentication.
...
documents and biometrics,  reduces the likelihood of individuals using fraudulent identification to establish
an identity,  or at  least  increases the work factor of potential  adversaries.  Acceptable forms of evidence
are consistent with the risk to the systems, roles  and  privileges associated with the user’s account.
(CE-3) Identity Evi
...
See Section 3.3.8, Public-Facing Systems, for additional information regarding multifactor requirements
and solutions.
4.8 INCIDENT RESPONSE
Reference Section 1.8.4 I ncident Response f or specific instructions on incident response requirements
...
breaches that could potentially affect the organization’s operations, assets, and in dividuals.
...
Supplemental Guidance: Agencies involved in supply chain activities  include,
for  example,
system/product  developers, integrators,  manufacturers, packagers, assemblers, distributors, vendors,  and
resellers. Supply chain incidents include,  for example,  compromises/breaches involving system
components,  information technology products, development  processes or personnel  and  distribution
...
that offers advice and assistance to users of the system for the handling and reporting of incident s.
...
the assistance capability, or the assistance capability can proactively send information to users (genera l
...
Control Enhancements:
(CE-1) Breaches: Include the following in the Incident Response Plan for breaches involving personally
identifiable information:
...
c.  Report anomalies in visitor access  records to agenc y-defined personnel.
Reference Secti
on 2.B.3.2, Authorized Access List for visitor access (AAL) requirements.
...
expression of the security,  privacy  and  supply chain risk tolerance for the organization; acceptable risk
assessment methodologies; security, privacy  and  supply chain risk mitigation strategies; a process for
consistently evaluating security, privacy  and  supply chain risk across the organization with respect to the
organization’s risk tolerance; and approaches for monitoring risk over time. The senior accountable
official  for risk management (agency head or designated official) aligns information security management
processes with strategic, operational,  and  budgetary planning processes. The use of a risk executive
function,  led by the senior accountable official for risk  management, can facilitate consistent  application of
...
processes; and
b.	 Establish a Risk Executive (function) to view and analyze risk from an organizatio n-wide
...
notification as described in Section 2.E.6, Notification Reporting Requirements.
...
system components, see the Office of Safeguards website.
...
a.
Impl
ement a managed interface for each external telecommunication service;
...
(CE-12) Host-Based Protection: Implement firewalls and intrusion detection systems at access points and
...
(IRS-Defined): Agencies must block known malicious sites (inbound or outbound), as identified to t he
...
their key management requirements in accordance with applicable laws, Executive Orders, direct ives,
...
Supplemental Guidance: System monitoring includes  external
and internal  monitoring. External
...
generated indications of compromise or potential compromise occur: suspicious activity reported f rom
...
administrators, mission or business owners, system owners, system security officer s or privacy officers.
...
w
ithin agency systems include large file transfers, long-time persistent connections, attempts to access
information from unexpected locations, the use of unusual  protocols and ports, the use of  unmonitored
...
defined personnel to lead and support the following SCRM activities: provide expertise in acquisition
...
regulations) to be necessary or appropriate to protect the confidentiality of the returns or r eturn
information;
...
(b)  Exceptions
N
o liability shall  arise under this  section with respect to any inspection or  disclosure-
...
cert
ification  failure under subsection (d) thereof) shall  be treated as return information, and
...
delegate’s signature, to SafeguardReports@irs.gov. Ensure that the letter contains the following specific
information:
...
(see Section 2.E.6.2, Contractor or Sub-contractor Access). Templates can be located on the Office of
Safeguards website.
...
(2) The contractor  and c ontrac tor’s officers or employees to be authorized access  to FTI must meet
...
(3) Each officer  or employ ee of  a contractor  to whom FTI is or may be disclosed shall be notified in writing
...
understanding of the agency’s security policy and procedures for safeguarding FTI. The initial certif ication
...
7213, 7213A (the Taxpayer Browsing Protection Act),  and 7431. This system and equipment  are subject
to monitoring to ensure proper  performance of  applicable security  features  or  procedures.  Such
monitoring may result  in the acquisition, recording,  and analysis of all data being communicated,
transmitted,  processed, or  stored in this system by a  user. If monitoring reveals  possible evidence of
...
COMPUTER  SYSTEM MAY SUBJECT  YOU TO  STATE AND  FEDERAL CRIMINAL  PROSECUTION
AND PENALTIES  AS W ELL AS CIVIL  PENALTIES.
-
...
Bulk Transfer Log) See Section 2.A.2 Five (5) Years
Converted Media
...
Compromise: The di sclosure of sensitive information to persons  not  authorized to receive such
information.
Commingling: The pr esence of FTI and non-FTI data together on the same paper or electronic media.
Confi
dentiality: The preservation of authorized restrictions on information access and disclosure.
Configuration management:  A struc tured process of managing and controlling changes to hardware,
software, firmware, communications,  and  documentation throughout the system development  life cycle.
Container: An obj ect that can be used to hold or transport something.
Conta
inerize: To package (freight) in uniform, sealed containers for shipment.
Contractor: Indepe ndent entity that  agrees to furnish certain number or  quantity of goods, material,
...
Control schedule: A record retention and disposal  schedu le established by  the agency.
...
Decryption: The pr ocess of converting encrypted information into a readable form. This term is also
referred to as deciphering.
Degau
ss: To erase information electromagnetically from a magnetic disk or other storage device.
Digital subscription line: A pu blic telecommunications technology that  delivers high bandwidth over
...
Discretionary access  co ntrol: A method of restricting logical access  to information system objects (e.g.,
...
Internet: Two or more networks connected by a router; the world’s largest network, which uses TC P/IP to
...
information quickly and privately between authorized user communities, including organi zations, vendors,
...
Container  .... 31, 50 , 51, 54, 55, 56, 105, 221
Contr actor 15, 16, 17, 26, 28, 34, 35, 36, 38,
...
179, 198, 212, 221
Encryption29, 41, 55, 57, 76, 77, 80, 86, 91,
...
Unauthorized Disclosure . 12, 16 , 32, 39, 41,
...
Website ...  16, 28 , 37, 40, 48, 73, 74,  75, 80,
86, 87, 89, 91, 93, 94, 95, 103, 105, 106,
117, 122, 138, 143, 152,  159, 182, 185,
190, 213
Publication 1075 (Rev. 11-2021)  Catalog Number 46937O
