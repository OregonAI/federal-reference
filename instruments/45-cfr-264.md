...
jurisdiction: us
id: 45-cfr-264
title: Other Accountability Provisions
...
superseded_by: null
source_url: https://www.ecfr.gov/api/versioner/v1/full/2026-08-31/title-45.xml?part=264
source_format: xml
...
**45 CFR 264** — Other Accountability Provisions
...
- Extent: 26 sections, 0 appendices, 3 subparts
...
(a) The amount that we will pay to a State in a fiscal year will not exceed an amount equal to 1/12 times 20 percent of that State's SFAG for that fiscal year, multiplied by the number of eligible months for which the State has requested contingency funds;
